...
class TheThread implements Runnable {
	public void run() {
		...
		System.out.println("State of thread1 while it called join() method on thread2 -" + Multithreading7States.thread1.getState());
		try {
			Thread.sleep(200);
		} catch (InterruptedException e) {
			e.printStackTrace();
...
public class Multithreading7States implements Runnable {
	public static Thread thread1;
	public static Multithreading7States obj;

	public static void main(String[] args) {
		
		obj = new Multithreading7States();
